...
public class DecibelSoundEvents {
    ...
    public static final SoundEvent ITEM_CHORUS_EAT = createItemSound("chorus", "eat");
    public static final SoundEvent ITEM_CHORUS_BURP = createItemSound("chorus", "burp");
    ...
    public static final SoundEvent ITEM_SWORD_SWING = createItemSound("sword", "swing");
    public static final SoundEvent ITEM_PICKAXE_SWING = createItemSound("pickaxe", "swing");
    public static final SoundEvent ITEM_AXE_SWING = createItemSound("axe", "swing");
    public static final SoundEvent ITEM_SHOVEL_SWING = createItemSound("shovel", "swing");
    public static final SoundEvent ITEM_HOE_SWING = createItemSound("hoe", "swing");
